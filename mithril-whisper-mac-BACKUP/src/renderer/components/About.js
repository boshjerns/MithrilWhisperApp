...
function About() {
  const faqSections = [
    ...
    {
      question: "What is the licensing for this application?",
      answer: (
        <div>
          <div className="licensing-info">
            <h5><LockIcon size={18} className="license-icon" /> Creative Commons BY-NC-SA 4.0</h5>
            <p>This application is licensed under the <strong>Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</strong>.</p>
            
            <div className="license-breakdown">
              <div className="license-section">
                <h6><RocketIcon size={16} className="section-icon" /> Personal Use: <span className="status-free">FREE</span></h6>
              ...
              <div className="license-section">
                <h6><BuildingIcon size={16} className="section-icon" /> Commercial Use: <span className="status-license">LICENSE REQUIRED</span></h6>
                <p>Commercial use requires a separate commercial license agreement.</p>
                <ul>
                  <li>🔒 SaaS offerings</li>
                  <li>🔒 Revenue-generating applications</li>
            ...
            <div className="license-contact">
              <h6><MailIcon size={16} className="contact-icon" /> Commercial Licensing</h6>
              <p>For commercial licensing inquiries, please contact:</p>
              <a href="mailto:boshjerns@gmail.com?subject=Commercial License Inquiry - MITHRIL WHISPER" className="license-contact-link">
                <MailIcon size={18} className="contact-icon" />
                <span>Josh Berns at boshjerns@gmail.com</span>
              </a>
            </div>
            
            <div className="license-links">
              <a href="https://github.com/boshjerns/MithrilWhisperApp/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="license-link">
                <FileIcon size={16} /> View Full License
              </a>
              <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank" rel="noopener noreferrer" className="license-link">
