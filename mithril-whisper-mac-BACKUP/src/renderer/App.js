        ...
        try {
          ...
          recognition.onresult = (event) => {
            ...
            for (let i = event.resultIndex; i < event.results.length; i++) {
              ...
              if (event.results[i].isFinal) {
                ...
                console.log('✅ Final transcript: length=', transcript ? transcript.length : 0);
              } else {
                interimTranscript += transcript;
                console.log('⏳ Interim transcript: length=', transcript ? transcript.length : 0);
              }
            }
            ...
            if (fullTranscript) {
              console.log('📤 Sending speech result to main: length=', fullTranscript.length);
          ...
          recognition.onend = () => {
            ...
            if (finalTranscript.trim()) {
              console.log('📤 Sending final transcript: length=', finalTranscript.trim().length);
              ipcRenderer.send('speech-recognition-result', {
