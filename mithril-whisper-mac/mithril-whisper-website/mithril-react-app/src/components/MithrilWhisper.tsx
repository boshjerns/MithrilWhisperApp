 ...
 ╚══╝╚══╝ ╚═╝  ╚═╝╚═╝╚══════╝╚═╝     ╚══════╝╚═╝  ╚═╝`}</pre>
        ...
        <div className="space-y-2 mb-4">
          ...
          <a 
            ...
            className="clean-download-windows block w-full px-4 py-3 rounded-lg font-medium transition-all duration-200 hover:shadow-lg text-sm">
        ...
        <div className="flex justify-center mb-3">
          <a 
            ...
            target="_blank" 
            className="inline-flex items-center space-x-3 text-gray-400 hover:text-white transition-colors text-sm">
