          ...
          <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-3 flex-nowrap">
            <div className="nav-attribution text-gray-300 hover:text-white transition-colors text-xs flex items-center flex-nowrap">
              ...
              <a href="https://x.com/deployforward" target="_blank" 
                 className="ml-1 p-1 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors inline-flex">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              <button 
                className="p-1 theme-toggle-nav group" 
                onClick={toggleTheme} 
              ...
              <a 
                ...
                target="_blank" 
                className="p-1 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors group">
                <svg 
